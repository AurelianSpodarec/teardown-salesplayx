function HomeSectionCTA() {
  return (
    <section className="bg-[#8f4764] relative overflow-hidden">
      ...
      <div className="overflow-hidden relative h-auto py-24 bg-no-repeat z-10">
        <div className="container px-16 mx-auto">
          ...
          <div className="flex gap-32">
            ...
            <div>
              <div className="mb-6">
                <h3 className="text-5xl mb-4 max-w-md font-bold text-white font-roboto">See SalesPlayX.ai platform in action</h3>
                <p className="text-white text-sm max-w-[480px]">Get a demo to see how top teams use SalesPlayX.ai to automate research and supercharge prospecting efficiency.</p>
              </div>
              <button className="flex items-center align-center space-x-2 py-5 px-7 xs:py-4 xs:px-8 mr-4 bg-[#1b1b1b] text-[#ebebeb] hover:bg-blue-700 xs:text-lg text-center font-semibold leading-none rounded-2xl transition duration-100">
